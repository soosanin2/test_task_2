...
Создан был в рамках тестового задания, и не является мануалом. Предшествующая версия проекта доступна по ссфлке https://github.com/soosanin2/Test_task.git
